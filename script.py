...
query = "SELECT Name, pse__Estimated_Hours__c FROM pse__Est_Vs_Actuals__c" #join to project table and join back to opportunity table, then pull forward sales channel
...
df = df[['Name', 'pse__Estimated_Hours__c']]
